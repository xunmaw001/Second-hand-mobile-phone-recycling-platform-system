...
<body>
  <div id="app">
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in shoujishangchengRecommend" v-bind:key="index" @click="jump('../shoujishangcheng/detail.jsp?id='+item.id)">
              <img :src="item.tupian?item.tupian.split(',')[0]:''" width="310" height="350" />
              <div class="about-culture-words">
                <h6>{{item.mingcheng}}</h6>
                <p></p>
              </div>
            </li>
          </ul>
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in shoujishangchengList" v-bind:key="index" @click="jump('../shoujishangcheng/detail.jsp?id='+item.id)">
              <img :src="item.tupian?item.tupian.split(',')[0]:''" width="310" height="350" />
              <div class="about-culture-words">
                <h6>{{item.mingcheng}}</h6>
  ...
  <script>
    var vue = new Vue({
      ...
      shoujishangchengRecommend: [],

      shoujishangchengList: [],
        newsList: []
      },
      filters: {
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`shoujishangcheng/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.shoujishangchengRecommend = res.data.list;
      });

      http.request(`shoujishangcheng/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.shoujishangchengList = res.data.list;
      });
    });
  </script>
</body>
