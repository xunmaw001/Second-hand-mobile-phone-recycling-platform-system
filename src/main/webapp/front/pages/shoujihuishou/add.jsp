		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="pinpai" id="pinpai" lay-filter="pinpai">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in pinpai" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
                        ...
                        <div class="layui-input-block">
                            <select name="chengse" id="chengse" lay-filter="chengse">
                                <option value="">请选择</option>
						...
						<div class="layui-input-block">
							<textarea name="gengduo" id="gengduo">请输入更多</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																																...
                																																http.request(`option/shoujipinpai/pinpai`,'get',{},(res)=>{
					vue.pinpai = res.data
				});
																vue.chengse = '全新,九成新,八成新,七成新,六成新,五成新,四成新,三成新,二成新,一成新,战损版'.split(',')
																								// 上传图片
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					var gengduo = tinymce.get('#gengduo').getContent()
					data.gengduo = gengduo;
					...
					// 提交数据
					http.requestJson('shoujihuishou' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
