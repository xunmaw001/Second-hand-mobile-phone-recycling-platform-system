...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<button class="btn-upload" id="jiance">点击下载</button>
									</div>
									<div class="form-group col-md-6">
									<label>估价</label>

									<input id="gujia" name="gujia" class="form-control" v-model="ruleForm.gujia" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>手机</label>
	...
	<script>
		...
		function setDownloadBtn(){
			var jianceUrl = "download('" + ruleForm.jiance + "')";
			$("#jiance").attr("onclick",jianceUrl);
		}			
		//设置音视频播放链接
