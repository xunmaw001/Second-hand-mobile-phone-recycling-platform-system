...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">手机估价管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>手机估价列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">手机估价列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="chengseSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										状态
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>图片</th>
											<th>检测</th>
											<th onclick="sort('gujia')">估价<i id="gujiaIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#chengseSearch').val() != null && $('#chengseSearch').val() != ''){
				searchForm.chengse ="%" +  $('#chengseSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var jianceCell  = document.createElement('td');

						  var jianceFile = document.createElement('button');
			  jianceFile.setAttribute('class','btn-table')
			  jianceFile.innerHTML = '下载';
			  var jianceFileAttr = "download('" + item.jiance + "')"
			  jianceFile.setAttribute('onclick',jianceFileAttr);
        	          jianceCell.appendChild(jianceFile);


			row.appendChild(jianceCell);
			var gujiaCell  = document.createElement('td');

						 gujiaCell.innerHTML = item.gujia;


			row.appendChild(gujiaCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shoujigujia/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shoujigujia");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"shoujigujia");
