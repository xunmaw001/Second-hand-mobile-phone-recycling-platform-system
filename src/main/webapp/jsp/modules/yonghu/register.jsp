...
<style>
	...
	body {
				background-image: url(http://codegen.caihongy.cn/20210225/5b957b8a8ed2416fbe4b63c1a7e6a9b3.jpg) !important;
	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input type="text" name="dizhi" placeholder="地址" class="form-control-i">
							</div>
